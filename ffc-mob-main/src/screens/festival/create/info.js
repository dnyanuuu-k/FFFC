...
const infoNote = {
	...
	[infoType.festival_focus]:
		'If your festival focuses on perticular category select those',
	...
	[infoType.venue]: 'Enter location where your event will take place',
	[infoType.listingUrl]: 'Shareable and unique url for your festival',
};
