...
export const PhotoFilmUploadEndpoint = 'photos/upload_film_photo';
...
export const createFestivalAlbum = ({
	festivalId,
	festivalPhotoId,
	id,
	name,
...
export const festivalAlbums = ({ festivalId, festivalPhotoId }) => {
...
export const addFestivalPhotoToAlbum = ({
	festivalPhotoId,
	festivalAlbumId,
}) => {
...
export const uploadTempAvatar = async (file) => {
	return multipartUpload('photos/upload_temp_avatar', {}, file);
};

export const filmPhotos = (filmId) => {
	return perform('photos/film_photos', {
		filmId,
	});
};

export const deleteFilmPhoto = (filmPhotoId) => {
	return perform('photos/delete_film_photo', {
		filmPhotoId,
	});
};
